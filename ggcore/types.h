...
//                    }
        ...
        py::handle get_object() {
            if (m_type == Type::py_none){
                ...
                py::object obj = py::cast(ent);
                std::cout << "\tTValue.get_object(): TEntity* -> py::object casting complete" << std::endl;
                return obj;
                throw "TValue.getattr : TEntity getter failed.";
            }
        }
        ...
        PEntity get_entity() {
            return std::get<PEntity>(m_value);
        }
