...
#ifndef GGSOLVER_STPTB_H
#define GGSOLVER_STPTB_H
...
namespace ggsolver {
    namespace stptb {
        ...
        /// Class declaration
        class TSTPTBGame;         // (Stochastic) Two Player Game on Graph
        class TSWReach;
        class TASWReach;
        class TPWReach;

        /// Type definitions for shared_ptr.
        typedef std::shared_ptr<TSTPTBGame> PSTPTBGame;
        ...
        class TSTPTBGame : public TGame {
        public:
            TSTPTBGame(std::string name) : TGame(name) {
